        ...
        <div class="p-5">
          ...
          <form class="user mt-5">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-6">
                <input type="password" class="form-control form-control-user" id="exampleRepeatPassword" placeholder="Repite tu contraseña">
              </div>
            </div>
          ...
          <hr>
          <div class="text-center">
            <a class="small" href="<?php echo SERVERURL; ?>Home/">Ya tienes una cuenta? Inicia sesión</a>
          </div>
        </div>
      </div>
    </div>
